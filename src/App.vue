...
.article-item {
  background-color: rgb(24, 124, 239);
  padding: 15px;
  border: 1px solid #ddd;
  border-radius: 4px;
  margin-bottom: 10px;
...
.button1:hover::after {
  ...
  border: 3px solid rgb(13, 246, 67);
}

.button1:hover {
  text-shadow: -1px -1px 0px #05ff50, 1px 1px 0px #fe0afe;
}

.button1:hover {
  background-color: transparent;
  border: 1px solid rgb(66, 9, 237);
  box-shadow: 0px 10px 10px -10px rgb(204, 252, 10);
}
